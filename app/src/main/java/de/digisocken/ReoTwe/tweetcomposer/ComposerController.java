...
class ComposerController {
    ...
    class ComposerCallbacksImpl implements ComposerCallbacks {
        ...
        public void onTextChanged(String text) {
            ...
            if (isTweetTextOverflow(charCount)) {
                composerView.setCharCountTextStyle(com.twitter.sdk.android.tweetcomposer.R.style.tw__ComposerCharCountOverflow);
            } else {
                composerView.setCharCountTextStyle(com.twitter.sdk.android.tweetcomposer.R.style.tw__ComposerCharCount);
            }
    ...
    static int remainingCharCount(int charCount) {
        return MAX_TWEET_LENGTH - charCount;
    }
    ...
    static boolean isPostEnabled(int charCount) {
        return charCount > 0 && charCount <= MAX_TWEET_LENGTH;
    }
    ...
    static boolean isTweetTextOverflow(int charCount) {
        return charCount > MAX_TWEET_LENGTH;
    }

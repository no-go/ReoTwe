...
public class ComposerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int themeResId = intent.getIntExtra(EXTRA_THEME, com.twitter.sdk.android.tweetcomposer.R.style.ComposerLight);

        setTheme(themeResId);
        setContentView(com.twitter.sdk.android.tweetcomposer.R.layout.tw__activity_composer);
    ...
    public static class Builder {
        ...
        private int themeResId = com.twitter.sdk.android.tweetcomposer.R.style.ComposerLight;
        ...
        public Builder darkTheme() {
            themeResId = com.twitter.sdk.android.tweetcomposer.R.style.ComposerDark;
            return this;
        }

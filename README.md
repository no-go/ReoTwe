...
You can get a signed APK from here (Android 4.1+): [APK](https://github.com/no-go/ReoTwe/blob/master/app/release/de.digisocken.reotwe.apk?raw=true)
...
### Twitter Kit, Google and Twitter API
